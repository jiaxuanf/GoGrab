...
<div>
    <div class="navbar">
      <a href="#profile">
        <img v-bind:src="'https://cdn2.iconfinder.com/data/icons/facebook-51/32/FACEBOOK_LINE-01-512.png'"
    ...
    <div class="main">
      ...
      <form id="mainsearch">
        ...
        <input class="inputs" type="text" placeholder="Enter location" >
        <label for="fromtime">
        ...
        <button type="submit" form="mainsearch" value="Search"> Search</button>
        <div class="section">
